...
function getHouseInfoFromId($bdd, $id){
    $statement = $bdd->prepare('SELECT name, surface, nbPeople, addressNumber, addressStreet, addressZipCode, addressCity, addressCountry, id_tenant FROM residence WHERE ID = :ID');
